...
export default function AboutSection({ isTheme }) {
  // Filtered to ONLY genuine core tools requested:
  // Row 1: Frontend & Core Languages (Outline SVG Icons)
  const row1 = [
    {
      name: "React",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="React">
    ...
    },
    {
      name: "Next.js",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="Next.js">
    ...
    },
    {
      name: "TypeScript",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="TypeScript">
    ...
    },
    {
      name: "JavaScript",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="JavaScript">
          <rect x="3" y="3" width="18" height="18" rx="2" />
    ...
    },
    {
      name: "Tailwind CSS",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="Tailwind CSS">
    ...
    },
    {
      name: "HTML5",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="HTML5">
    ...
    },
    {
      name: "CSS3",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="CSS3">
          <path d="M4 3l1.8 17.5L12 22l6.2-1.5L20 3H4z" />
          <path d="M7.5 7h9l-.4 4.5h-8l.3 4 3.6 1 3.6-1 .3-3" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      ),
    },
  ];

  // Row 2: Backend, Auth, Payments, APIs & Deployment (Outline SVG Icons)
  const row2 = [
    {
      name: "Supabase",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="Supabase">
    ...
    },
    {
      name: "Firebase",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="Firebase">
    ...
    },
    {
      name: "Paystack",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="Paystack">
    ...
    },
    {
      name: "REST APIs",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="REST APIs">
    ...
    },
    {
      name: "Git & GitHub",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="Git">
          <circle cx="6" cy="6" r="2.5" />
          <circle cx="6" cy="18" r="2.5" />
          <circle cx="18" cy="12" r="2.5" />
    ...
    },
    {
      name: "Vercel",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="w-5 h-5 shrink-0" aria-label="Vercel">
  ...
  // Quadruple items to ensure a silky seamless 100% loop with no gaps
  const stream1 = [...row1, ...row1, ...row1, ...row1];
  const stream2 = [...row2, ...row2, ...row2, ...row2];
  ...
  return (
    <section id="about" className="py-12 sm:py-16 md:py-20 border-b border-inherit scroll-mt-20">
      ...
      <motion.div
        ...
        className={`p-6 sm:p-8 md:p-10 border transition-all duration-300 mb-10 ${
          isTheme
      ...
      {/* Streamlined Minimal Infinite Marquee (No heavy card backgrounds, Outline SVGs, Clean Monospace text) */}
      <motion.div
        initial={{ opacity: 0 }}
        ...
        className="pt-2"
      >
        <div className="font-mono-tech text-xs tracking-widest uppercase mb-4 text-emerald-500 font-semibold flex items-center gap-2">
          <span className="inline-block w-2 h-2 bg-emerald-500 animate-pulse"></span>
          <span>TECH STACK</span>
        </div>

        <div className="relative w-full pause-on-hover py-2 space-y-4 overflow-hidden">
          {/* Left Fade Mask */}
          <div
            className={`absolute left-0 top-0 bottom-0 w-12 sm:w-24 z-10 pointer-events-none transition-colors ${
              isTheme
                ? "bg-gradient-to-r from-[#fafafa] via-[#fafafa]/80 to-transparent"
                : "bg-gradient-to-r from-[#090b0e] via-[#090b0e]/80 to-transparent"
            }`}
          />

          {/* Right Fade Mask */}
          <div
            className={`absolute right-0 top-0 bottom-0 w-12 sm:w-24 z-10 pointer-events-none transition-colors ${
              isTheme
                ? "bg-gradient-to-l from-[#fafafa] via-[#fafafa]/80 to-transparent"
                : "bg-gradient-to-l from-[#090b0e] via-[#090b0e]/80 to-transparent"
            }`}
          />

          {/* Stream 1: Leftward Marquee (Frontend & Core) */}
          <div className="overflow-hidden py-1">
            <div className="animate-marquee-left flex gap-8 sm:gap-12 items-center">
              {stream1.map((tech, idx) => (
                <div
                  key={`stream1-${tech.name}-${idx}`}
                  className={`flex items-center gap-2.5 select-none shrink-0 transition-transform hover:scale-105 ${
                    isTheme ? "text-neutral-800 hover:text-black" : "text-neutral-300 hover:text-white"
                  }`}
                >
                  <div className="shrink-0 opacity-85">
                    {tech.icon}
                  </div>
                  <span className="font-mono-tech text-xs sm:text-sm font-semibold tracking-tight">
                    {tech.name}
                  </span>
                </div>
              ))}
          ...
          {/* Stream 2: Rightward Marquee (Backend, Cloud, Payments, APIs) */}
          <div className="overflow-hidden py-1">
            <div className="animate-marquee-right flex gap-8 sm:gap-12 items-center">
              {stream2.map((tech, idx) => (
                <div
